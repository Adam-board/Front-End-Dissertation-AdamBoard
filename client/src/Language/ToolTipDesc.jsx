...
export const NewReport = `Begin a new report with a template of section headings displayed automatically and ready to edit.If you have unsaved changes when refreshing the browser, these will not be saved so be careful as you could lose a lot of work!`
export const LoadReport = `Load a previously worked on report to continue from when it was last saved.`
export const RemoveReport = `Choose a report to remove from the collection of reports. (BEWARE THIS IS PERMANENT)`
export const SaveReportTemplate = `Save your current template so it can be loaded again for later use!`
export const RemoveReportTemplate = `Remove a chosen template from the list of report templates.(BEWARE THIS IS PERMANENT)`
